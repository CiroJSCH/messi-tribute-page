...
const Highlights = () => {
	return (
		<section id="highlights" className="mt-20">
            ...
            Messi ha tenido muchisimos{' '}
						<span className="font-marker text-gradient-gold">
              momentos inolvidables
						</span>{' '}
            pero, a mi parecer, estos cinco son los más destacados:
					</p>
					<div className="flex items-center text-center gap-4">
						<AiFillInfoCircle className="text-blue text-[20px] hidden sm:flex" />
						<p className="text-gray-500 text-[18px] italic">
              Tocá la imagen para ver la información
						</p>
					</div>
				</div>
